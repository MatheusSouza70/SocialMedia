...
function Profile(props) {
  ...
  return (
    <ScrollView style={{ backgroundColor: "white" }}>
      ...
      {checkIfFriends ? (
        <ProfileButtons
          firstPlaceholder="Amigos"
          secondPlaceholder={"Sobre " + getUserProfileInfo.data.userName}
          firstIcon={friendsIcon}
          secondIcon={aboutIcon}
        />
      ) : checkIfRequestPending ? (
        <ProfileButtons
          firstPlaceholder="Pendente"
          secondPlaceholder={"Sobre " + getUserProfileInfo.data.userName}
        ...
        <ProfileButtons
          firstPlaceholder="Editar Perfil"
          secondPlaceholder="Meus Amigos"
        ...
        <ProfileButtons
          firstPlaceholder="Adicionar Amigos"
          secondPlaceholder={"Sobre" + getUserProfileInfo.data.userName}
