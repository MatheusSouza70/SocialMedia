...
function DashboardHeader(props) {
  ...
  return (
    <View style={styles.headerContainer}>
      <Text style={styles.social}>CringeMedia</Text>
            ...
            {fetchLikesNotifications.map((likes) => {
              return (
                <LikesNotifications
                  ...
                  placeholder="curtiu sua publicação."
            ...
            {fetchCommentNotifications.map((comment) => {
              return (
                <CommentNotifications
                  ...
                  placeholder="comentou sua publicação."
                ...
                return (
                  <View>
                    <Notifications
                      ...
                      userId={userId}
                      placeholder="adicionou você como amigo."
              ...
              if (notification.data.isFriend === true) {
                return (
                  <Notifications
                    ...
                    created={notification.data.created}
                    userId={userId}
                    placeholder="aceitou seu pedido de amizade."
                    isRead={notification.data.markedAsRead}
                  />
                );
              }
